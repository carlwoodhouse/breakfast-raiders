...
class SocialLinks extends Component  {
    render() {
        ...
        <div className="guildlinks">
            ...
            <a title='RaiderIO guild Profile' className='d-inline p-right' href={ "https://raider.io/guilds/" + config + "/" + process.env.GUILD_REALM + "/" + process.env.GUILD_NAME } target="_blank"><img src="icons/rio.svg" className="icon" alt="RaiderIO" /></a>
